...
class OptionsForm(FlaskForm):
    ...
    trad_tsp_base_rate_f = DecimalField('Trad TSP Base Rate (Future)', validators=[NumberRange(min=0, max=84)])
    trad_tsp_base_rate_m = SelectField('Trad TSP Base Rate Month', choices=[])
    roth_tsp_base_rate_f = DecimalField('Roth TSP Base Rate (Future)', validators=[NumberRange(min=0, max=60)])
    roth_tsp_base_rate_m = SelectField('Roth TSP Base Rate Month', choices=[])
    trad_tsp_specialty_rate_f = DecimalField('Specialty Rate (Future)', validators=[NumberRange(min=0, max=100)])
    trad_tsp_specialty_rate_m = SelectField('Specialty Rate Month', choices=[])
    roth_tsp_specialty_rate_f = DecimalField('Specialty Rate (Future)', validators=[NumberRange(min=0, max=100)])
    roth_tsp_specialty_rate_m = SelectField('Specialty Rate Month', choices=[])
    trad_tsp_incentive_rate_f = DecimalField('Incentive Rate (Future)', validators=[NumberRange(min=0, max=100)])
    trad_tsp_incentive_rate_m = SelectField('Incentive Rate Month', choices=[])
    roth_tsp_incentive_rate_f = DecimalField('Incentive Rate (Future)', validators=[NumberRange(min=0, max=100)])
    roth_tsp_incentive_rate_m = SelectField('Incentive Rate Month', choices=[])
    trad_tsp_bonus_rate_f = DecimalField('Bonus Rate (Future)', validators=[NumberRange(min=0, max=100)])
    trad_tsp_bonus_rate_m = SelectField('Bonus Rate Month', choices=[])
    roth_tsp_bonus_rate_f = DecimalField('Bonus Rate (Future)', validators=[NumberRange(min=0, max=100)])
