...
function buildInputForRow(rowHeader, config, options = {}) {
    let input;
    let id = options.id || '';
    ...
    if (rowHeader === 'Grade') {
        ...
        input.id = id;
        input.className = className;
        config.HOME_OF_RECORDS.forEach(opt => {
            let o = document.createElement('option');
            o.value = opt;
            o.textContent = opt;
            if (opt === value) o.selected = true;
        ...
        input.id = id;
        input.className = className;
        config.FEDERAL_FILING_STATUSES.forEach(opt => {
            let o = document.createElement('option');
            o.value = opt;
            o.textContent = opt;
            if (opt === value) o.selected = true;
        ...
        input.id = id;
        input.className = className;
        config.STATE_FILING_STATUSES.forEach(opt => {
            let o = document.createElement('option');
            o.value = opt;
            o.textContent = opt;
            if (opt === value) o.selected = true;
        ...
        input.id = id;
        input.className = className;
        config.SGLI_COVERAGES.forEach(opt => {
            let o = document.createElement('option');
            o.value = opt;
            o.textContent = opt;
            if (opt === value) o.selected = true;
        ...
        input.id = id;
        input.className = className;
        config.COMBAT_ZONES.forEach(opt => {
            let o = document.createElement('option');
            o.value = opt;
            o.textContent = opt;
            if (opt === value) o.selected = true;
    ...
    // Text/number inputs
    else if (rowHeader === 'Zip Code') {
        input = document.createElement('input');
        input.type = 'text';
        input.id = id;
        input.className = className;
        input.maxLength = 5;
        input.placeholder = placeholder || '12345';
        input.value = value;
        ...
        input.className = className;
        input.maxLength = 1;
        input.placeholder = placeholder || '0-9';
        input.value = value;
