...
def init_tables(les_variables, tsp_variables, month, les_text=None):
    ...
    if les_text:
        budget = add_budget_variables(budget, month, les_variables)
        ...
        budget = add_budget_variables(budget, month, les_variables)
        budget = add_calc_pay(budget, month, sign=1)
